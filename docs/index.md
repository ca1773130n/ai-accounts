...
features:
  ...
  - title: Batteries included
    details: Ships with SQLite, AES-GCM vault, twelve backends (Claude, Claude self-hosted, Codex, Antigravity, OpenCode, OpenRouter, Kimi, OpenAI-compatible, DeepSeek, Goose, Aider, Crush), and themeable Vue components.
  - title: Embeddable
