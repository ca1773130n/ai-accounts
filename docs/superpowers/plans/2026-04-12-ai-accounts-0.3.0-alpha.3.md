# 0.3.0-alpha.3: PTY Session System Implementation Plan
...
**Files:**
- Modify: all package manifests (version → 0.3.0a4 / 0.3.0-alpha.4)
- Modify: `CHANGELOG.md`

- [ ] **Step 1: Bump all versions**

Update version strings to alpha.4.

- [ ] **Step 2: Update CHANGELOG.md**

```markdown
## 0.3.0-alpha.4 (PTY) — 2026-04-XX
...
```bash
git add -A
git commit -m "release: 0.3.0-alpha.4 (PTY sessions)"
```
